...
// menu1.tytle = "Menu";
// document.writeln(
//   menu1.tytle + ": " + menu1.width + " x " + menu1.height + "<br>"
// );
// console.log(menu1);
...
// // document.writeln(menu.tytle + ": " + menu.width + " x " + menu.height + "<br>");
// let count = 0;
// menu.age = 25;
// for (let i in menu) {
...
// // header3.tel = "Hello";
// // header3.tel = "+7 111 999-88-77";

// header3.render("header-ext");

//------------------------------------->
// let info =
//   '{"first_name":"Ivan","age":36,"mother":{"name":"Olga"},"children":["Kate","Igor","Misha"],"married":true,"dog":null}';
// console.log(info);
...
//       setTimeout(function () {
//         console.log("Клиент: получил даные и отбражаю их");
//       }, 1000);
//     }, 500);
//   }, 500);
// }, 1000);
...
//           { uid: "id2", name: "Irina" },
//         ];
//         reject("База данных не смогла получить список ползователей");
...
//     return new Promise(function (resolve, reject) {
//       setTimeout(function () {
//         console.log("Клиент: получил даные и отбражаю их", users);
//         resolve();
//       }, 1000);
//     });
//   })
...
// let p1 = test(1000).then(() => ({name:'1000ms'}));
// let p2 = test(2000).then(() => ({name:'2000ms'}));
